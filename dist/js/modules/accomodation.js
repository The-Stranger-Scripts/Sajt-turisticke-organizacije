...
<section class="five-col-sec">
    <div class="accomodation-label">
        <h2>${dataContent[0].heading.title}</h2>
        <p>
        ${dataContent[0].heading.content}
        </p>
    </div>
    ...
    <div class="card-columns container-lg">
        <div class="accomodation-card">
            ...
            <div class="accomodation-card-body">
                <h4>Centar grada</h4>
                <p class="accomodation-text">
                    Kada je reč o lokacijama stanova, oni se nalaze u svim važnim gradskim delovima, kako u samom centru Novog Sada, tako i u prigradskim naseljima. Ukoliko je vaš izbor Novi Sad stan na dan, nesumnjivo je da ćete naći objekat koji će zadovoljiti sve vaše
                    kriterijume.
                </p>
            </div>
        </div>
        <div class="accomodation-card">
            ...
            <div class="accomodation-card-body">
                ...
                <p class="accomodation-text">
                    Posebna pogodnost boravka u Novom Sadu jesu vrlo pristupačne cene. Stan na dan možete rezervisati za manje od deset evra po osobi. Sa druge strane, u svakom apartmanu imaćete potpun komfor i sve što je potrebno za udoban i prijatan boravak. Za sve one
                    koji žele posebne pogodnosti Novi Sad je pripremio naročite vrste apartmana na periferiji grada okružene prirodnim lepotama.
                </p>
            </div>
        </div>
    </div>
...
<section class="one-col-sec">
    <div class="accomodation-label">
        ...
        <p>
            Već više od decenijju nastavlja se Exit festival koji postaje sve popularniji muzički festival na prostorima jugoistočne Evrope. Exit festival u Novom Sadu održava se svake godine u sredini leta i uvek je to negde oko 5. do 10. jula, što mnogima ostavlja
            prostor za rezervisanje sobe ili apartmana.U periodu pred sam početak Exita bukvalno je nemoguće pronaći mesto za noćenje pa čak ni za jednu osobu. Iz tog razloga savetujemo da se rentiranje stana obavi što pre.
        </p>
    </div>
    ...
    <div class="exit-video-container">
        ...
        <section class="three-col-sec">
            <div class="accomodation-label">
                ...
                <p>
                    Ukoliko ste se odlučili za prenoćište u Novom Sadu, predlažemo vam da razmotrite različite kategorije apartmana na dan i time sebi obezbedite najbolji mogući smeštaj za kratak izlet. Osim standardnih, kvalitet boravka može itekako popraviti boravak u
                    apartmanima sa bazenom, stanovima koji poseduju djakuzi, apartmanima na dan koji se nalaze u najužem centru i u najlepšim delovima Novog Sada, kao što su Stari grad i Liman.
                </p>
            </div>
            <div class="card-columns container-lg">
                <div class="accomodation-card">
                    ...
                    <div class="accomodation-card-body">
                        ...
                        <p class="accomodation-text">
                            Sada već tradicionalni Zimzolend nas čeka na Trgu slobode svakog dana tokom celog decembra – od 1. do 28. decembra. Zimzoland je do sada dokaz da sneg nije neophodan za uživanje u prazničnom duhu – prazničnim svećama i rasvetama, mirisu kuvanog vina
                            i medenjaka i neizbežni osmeh! U preko 30 novogodišnjih kućica moći ćete da probate i kupite najbolje domaće proizvode: slatkiše, kolače, kuvano vino, zanatsko pivo i drugu hranu i novogodišnje ukrase. Pored toga,
                            svako veče će nastupati dečiji horovi, a vikendom novosadski bendovi i di-džejevi.
                        </p>
                    </div>
                </div>
                <div class="accomodation-card">
                    ...
                    <div class="accomodation-card-body">
                        ...
                        <p class="accomodation-text">
                            Centar prestonice kulture odiše prazničnom atmosferom, raspoloženje ljudi je vidno drugačije, grad i ulice blistaju, dok ukrašeni centar grada izgleda magično!
                        </p>
                    </div>
                </div>
                <div class="accomodation-card">
                    ...
                    <div class="accomodation-card-body">
                        ...
                        <p class="accomodation-text">
                            Novosađani, ali i mnogobrojni turisti i gosti Novog Sada oduševljeni fijakerom i konjima. Probajte i vi!
                        </p>
                    </div>
                </div>
            </div>
